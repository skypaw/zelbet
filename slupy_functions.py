...
def start_parameters(epsilon_cu3_func, epsilon_c3_func, f_yd_func, es_func, a2_func, h_func, d_func):
    ...
    return x_lim_func, epsilon_yd_func, x_min_minus_yd_func, x_min_yd_func, x_0_func, x_max_yd_func
